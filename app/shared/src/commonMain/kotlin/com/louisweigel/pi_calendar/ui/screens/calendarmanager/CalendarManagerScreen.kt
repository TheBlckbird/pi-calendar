...
import pi_calendar.app.shared.generated.resources.add_2_24px
import pi_calendar.app.shared.generated.resources.arrow_back_24px
import pi_calendar.app.shared.generated.resources.calendarManager
import pi_calendar.app.shared.generated.resources.calendarManager_addCalendar
import pi_calendar.app.shared.generated.resources.calendarManager_calendarDeletionDescription
import pi_calendar.app.shared.generated.resources.calendarManager_chooseOtherName
import pi_calendar.app.shared.generated.resources.cancel
import pi_calendar.app.shared.generated.resources.confirmDeletion
import pi_calendar.app.shared.generated.resources.delete
import pi_calendar.app.shared.generated.resources.delete_24px
import pi_calendar.app.shared.generated.resources.edit_24px
import pi_calendar.app.shared.generated.resources.nameTaken
...
fun CalendarManagerScreen(
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                ...
                title = {
                    Text(stringResource(Res.string.calendarManager))
                },
            )
                    ...
                    headlineContent = {
                        TextButton(
                            ...
                            Row(
                                ...
                                Text(
                                    stringResource(Res.string.calendarManager_addCalendar),
                                    style = MaterialTheme.typography.labelLarge
                                )
                                Icon(painterResource(Res.drawable.add_2_24px), null)
                            }
                        }
                    }
                )
    ...
    if (showNameTakenDialog) {
        AlertDialog(
            ...
            title = {
                Text(stringResource(Res.string.nameTaken))
            },

            text = {
                Text(stringResource(Res.string.calendarManager_chooseOtherName))
            },
    ...
    if (deleteCalendarData != null) {
        AlertDialog(
            ...
            text = {
                Text(stringResource(Res.string.calendarManager_calendarDeletionDescription))
            },
