...
import pi_calendar_kmp.shared.generated.resources.addReminderMenu_dateTimeField
import pi_calendar_kmp.shared.generated.resources.addReminderMenu_isDone
    ...
    ModalBottomSheet(
        ...
        Column(
            ...
            Row(verticalAlignment = Alignment.CenterVertically) {
                ...
                Text(stringResource(Res.string.addReminderMenu_isDone))
            }
            ...
            Column(verticalArrangement = Arrangement.spacedBy((-10).dp)) {
                Text(
                    stringResource(Res.string.addReminderMenu_dateTimeField),
